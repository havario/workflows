...
(function (c) {
  ...
  c.fn.imgPreview = function (j) {
    ...
    h.mousemove(function (a) {
      d.css({ top: a.pageY + b.distanceFromCursor.top + "px", left: a.pageX + b.distanceFromCursor.left + "px" });
    }).hover(
      function () {
        var a = this;
  ...
  function i(t, e, n, r, a, o) {
    ...
    return (
      "auto" === d[1]
        ...
        : -1 !== ("" + d[1]).indexOf("%")
        ? ((s = parseFloat(d[1]) / 100), (i = n.height * s), "backgroundSize" !== t && (i -= (o || r).height * s))
        : (i = parseInt(d[1], 10)),
      [l, i]
    );
  }
      ...
      var e,
        ...
        f = function () {
          e &&
            ...
            n && s.push(n),
            "-" === e.substr(0, 1) && (a = e.indexOf("-", 1) + 1) > 0 && ((r = e.substr(0, a)), (e = e.substr(a))),
        ...
        if (o)
          switch (o[1]) {
            ...
            case "-o-linear-gradient":
              if (
                ((n = { type: "linear", x0: null, y0: null, x1: null, y1: null, colorStops: [] }),
                (l = o[2].match(/\w+/g)))
              )
            ...
            case "-webkit-gradient":
              if (
                ((n = { type: "radial" === o[2] ? "circle" : o[2], x0: 0, y0: 0, x1: 0, y1: 0, colorStops: [] }),
            ...
            case "-moz-linear-gradient":
              if (
                ((n = { type: "linear", x0: 0, y0: 0, x1: 0, y1: 0, colorStops: [] }),
            ...
            case "-o-radial-gradient":
              if (
                ...
                (l = o[2].match(/(\d{1,3})%?\s(\d{1,3})%?/)),
                l && ((n.cx = (l[1] * e.width) / 100), (n.cy = (l[2] * e.height) / 100)),
                (l = o[3].match(/\w+/)),
                (d = o[4].match(/[a-z\-]*/)),
                l && d)
              )
                switch (d[0]) {
                  ...
                  case "farthest-side":
                    "circle" === l[0]
                      ? (n.rx = n.ry = Math.max(n.cx, n.cy, n.x1 - n.cx, n.y1 - n.cy))
                      : ((n.type = l[0]), (n.rx = Math.max(n.cx, n.x1 - n.cx)), (n.ry = Math.max(n.cy, n.y1 - n.cy)));
                    break;
                  case "closest-side":
                  case "contain":
                    "circle" === l[0]
                      ? (n.rx = n.ry = Math.min(n.cx, n.cy, n.x1 - n.cx, n.y1 - n.cy))
                      : ((n.type = l[0]), (n.rx = Math.min(n.cx, n.x1 - n.cx)), (n.ry = Math.min(n.cy, n.y1 - n.cy)));
                }
              if (
                (l = o[5].match(
                  /((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g
    ...
    (u.Parse = function (r, a) {
      ...
      function v(t, e, n) {
        ...
        ue.trimText(e.nodeValue).length > 0 &&
          ...
          (o =
            !a.letterRendering && /^(left|right|justify|auto)$/.test(c) && p(ge(t, "letterSpacing"))
              ? e.nodeValue.split(/(\b| )/)
              : e.nodeValue.split("")),
          (r = m(i, t, s, l)),
          a.chinese &&
      ...
      function B(t, e, n, r, a, o, i) {
        ...
        return (
          ...
          n[0] > 0 || n[1] > 0
            ...
            : (l.push(["line", t.c2[0], t.c2[1]]), l.push(["line", t.c3[0], t.c3[1]])),
          e[0] > 0 || e[1] > 0
            ? (l.push(["line", a[1].end.x, a[1].end.y]), a[1].curveToReversed(l))
          ...
          if (n[r].width > 0) {
            switch (((a = c), (o = d), (i = u), (l = h - n[2].width), r)) {
              case 0:
                (l = n[0].width),
                  (s = B(
                    { c1: [a, o], c2: [a + i, o], c3: [a + i - n[1].width, o + l], c4: [a + n[3].width, o + l] },
                    f[0],
                    f[1],
                    p.topLeftOuter,
                    p.topLeftInner,
              ...
              case 1:
                (a = c + u - n[1].width),
                  (i = n[1].width),
                  (s = B(
                    { c1: [a + i, o], c2: [a + i, o + l + n[2].width], c3: [a, o + l], c4: [a, o + n[0].width] },
                    f[1],
                    f[2],
                    p.topRightOuter,
                    p.topRightInner,
              ...
              case 2:
                (o = o + h - n[2].width),
                  (l = n[2].width),
                  (s = B(
                    { c1: [a + i, o + l], c2: [a, o + l], c3: [a + n[3].width, o], c4: [a + i - n[3].width, o] },
                    f[2],
                    f[3],
                    p.bottomRightOuter,
                    p.bottomRightInner,
              ...
              case 3:
                (i = n[3].width),
                  (s = B(
                    { c1: [a, o + l + n[2].width], c2: [a, o], c3: [a + i, o + n[0].width], c4: [a + i, o + l] },
                    f[3],
                    f[0],
                    p.bottomLeftOuter,
                    p.bottomLeftInner,
      ...
      function D(t, e, n) {
        ...
        i.forEach(function (e) {
          ...
          (/^(submit|reset|button|text|password)$/.test(t.type) || "SELECT" === t.nodeName) &&
      ...
      function re(t, e, n, r) {
        ...
        switch (
          ...
          c.save(),
          c.clip(),
          d.height > 0 && d.width > 0 && !r ? (X(c, i, h), Y(t, d, c)) : r && (l.backgroundColor = h),
          c.restore(),
          ...
          case "IMG":
            (a = M(t.getAttribute("src")))
              ? I(c, t, a, i, s)
              : ue.log("html2canvas: Error loading <img>:" + t.getAttribute("src"));
            break;
          case "INPUT":
      ...
      function ae(t) {
        return (
          "none" !== ge(t, "display") && "hidden" !== ge(t, "visibility") && !t.hasAttribute("data-html2canvas-ignore")
        );
      }
      function oe(t, e, n) {
      ...
      function o() {
        x.log("html2canvas: start: images: " + w.numLoaded + " / " + w.numTotal + " (failed: " + w.numFailed + ")"),
          !w.firstRun &&
            ...
            (x.log("Finished loading images: # " + w.numTotal + " (failed: " + w.numFailed + ")"),
        ...
        u.Util.parseBackgroundImage(t)
          ...
          .forEach(function (t) {
            "url" === t.method
              ...
              : t.method.match(/\-?gradient$/) && (r === n && (r = u.Util.Bounds(e)), c(t.value, r));
          });
      }
      function f(t) {
        var e = !1;
              ...
              t &&
                ...
                t.match(/data:image\/.*;base64,/i)
                  ? ((e.src = t.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, "")),
                    ...
                    p(e, o))
                  : a(t) || r.allowTaint === !0
                  ? ((o = w[t] = { img: e }), w.numTotal++, p(e, o), (e.src = t))
                  : R && !r.allowTaint && r.useCORS
                  ? ((e.crossOrigin = "anonymous"), (o = w[t] = { img: e }), w.numTotal++, p(e, o), (e.src = t))
                  : r.proxy && ((o = w[t] = { img: e }), w.numTotal++, i(t, e, o)));
            },
            cleanupDOM: function (a) {
              ...
              if (!w.cleanupDone) {
                a && "string" == typeof a
                  ...
                  : x.log("html2canvas: Cleanup after timeout: " + r.timeout + " ms.");
                for (l in w)
                  if (
                    w.hasOwnProperty(l) &&
                    ((i = w[l]), "object" == typeof i && i.callbackname && i.succeeded === n)
                  ) {
                    t[i.callbackname] = n;
                    try {
                    ...
                    i.script &&
                      i.script.parentNode &&
                      (i.script.setAttribute("src", "about:blank"), i.script.parentNode.removeChild(i.script)),
                      w.numLoaded++,
                      w.numFailed++,
                      x.log(
                        "html2canvas: Cleaned up failed img: '" + l + "' Steps: " + w.numLoaded + " / " + w.numTotal
                      );
                  }
          ...
          (r = (function (t) {
            function e(t, r, a) {
              ...
              r.zIndex.ownStacking
                ? ((i = c.context = { "!": [{ node: r, children: [] }] }), (d = n))
                : (l || s) && (d = c.children = []),
        ...
        (o.complete = function (t) {
          ("function" != typeof o.onpreloaded || o.onpreloaded(t) !== !1) &&
            ...
            ("function" != typeof o.onparsed || o.onparsed(r) !== !1) &&
              ((a = u.Renderer(r, o)), "function" == typeof o.onrendered && o.onrendered(a)));
        }),
...
!(function (c) {
  ...
  var e = function (h, g) {
    ...
    this.linkFormat = b.parseFormat(
      g.linkFormat || this.element.data("link-format") || b.getDefaultFormat(this.formatType, "link"),
      this.formatType
    );
    ...
    this.picker = c(b.template)
      .appendTo(this.isInline ? this.element : "body")
      .on({ click: c.proxy(this.click, this), mousedown: c.proxy(this.mousedown, this) });
  ...
  var methods = {
    destroy: function () {
      this.each(function (i, el) {
        ...
        var mEvt = { down: "mousedown", up: "mouseup", move: "mousemove" };
    ...
    init: function (options) {
      this.each(function (i, el) {
        ...
        var settings = $.extend(
          {
            ...
            unit: "%",
            pill: true,
            snap: { marks: false, type: false, points: 0 },
            disabled: false,
            colorShift: [],
            vertical: false,
            showKnob: true,
        ...
        var THE_VALUE = (valueObj[guid] = settings.startAt),
          ...
          customRange =
            (settings.totalRange[0] !== 0 || settings.totalRange[1] !== 0) &&
            settings.totalRange[0] < settings.totalRange[1],
        ...
        if (imageBln) {
          ...
          knob.children("img").load(function () {
            ...
            var knob_bg_styles = { width: knob_width, height: knob_height, background: knob_bg };
            ...
            self.css({ height: knob_height, "border-radius": r_corners ? thisHeight / 2 + "px" : "0" });
            imgEl.remove();
            if (thisHeight > settings.height) {
              ...
              knob.css({ top: "-" + knobMarginValue + "px" });
              follow.css({
        ...
        knob
          ...
          .css(cssContentBox);
        follow
          .css({ position: !settings.disabled ? "absolute" : "static", height: knob.height() + "px", width: "0" })
          .css(cssContentBox);
        ...
        var drawSnapmarks = function (resize) {
          ...
          if (markers) {
            ...
            for (var i = 0; i < snapValues.length; i++)
              str +=
                '<div style="display:inline-block; width:0; height:5px; border-left:#333 solid 1px; position:relative; left:' +
                (snapValues[i] - i) +
                'px; float:left"></div>';
            marks.html(str);
          }
        ...
        var verticalTransform = function () {
          if (markers && snaps > 0 && snaps < 10) {
            ...
            self.css({ margin: "0", top: "0", left: "0", "backface-visibility": "hidden" }).css(cssRotate);
          }
        };
        var drawButtons = function () {
            ...
            var vertStyles = "; z-index:1000; position:relative; top:30px",
              plusStr =
                '<div class="sglide-buttons" id="' +
                guid +
                '_plus" style="display:inline-block; cursor:pointer' +
                (vert ? vertStyles : "") +
                '">&nbsp;+&nbsp;</div>',
              minusStr =
                '<div class="sglide-buttons" id="' +
                guid +
                '_minus" style="display:inline-block; cursor:pointer' +
                (vert ? vertStyles : "") +
                '">&nbsp;&minus;&nbsp;</div>';
            if (markers) {
              var q = null;
              if (!vert) {
                ...
                a.wrapAll(
                  '<div id="' +
                    guid +
                    '_button-marks" style="display:inline-block; vertical-align:middle; width:' +
                    width +
                    unit +
                    '"></div>'
                );
              ...
              self.css({ display: !vert ? "inline-block" : "block", "vertical-align": "middle" });
              self.after(plusStr);
          ...
          btn_timers = null;
        var btn_snap =
          settings.snap.points > 0 && settings.snap.points <= 9 && (snapType == "hard" || snapType == "soft");
        var is_down = false;
        knob
          .on(mEvt.down, function () {
            is_down = true;
        ...
        var colorShiftInit = function () {
          ...
          follow.css({ overflow: "hidden", "background-color": settings.colorShift[0] });
          follow.html(
            '<div style="opacity:' +
              settings.startAt / 100 +
              "; height:100%; background-color:" +
              settings.colorShift[1] +
              '; "></div>'
          );
        };
