...
sed -i 's#https://unpkg.com/font-logos@0.17.0/assets/font-logos.css#https://cdn.jsdelivr.net/npm/font-logos@0.17.0/assets/font-logos.css#g' resource/template/common/header.html
...
sed -i 's#https://unpkg.com/font-logos@0.17.0/assets/font-logos.css#https://cdn.jsdelivr.net/npm/font-logos@0.17.0/assets/font-logos.css#g' resource/template/theme-server-status/header.html
